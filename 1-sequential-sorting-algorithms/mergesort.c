...
// the indexes I decided to make all functions pure as I like it that way but I
// guess modifing the passed arguments would have been a nice solution to ease// This is the solution I found, I'm not really satisfied with the `mergeArrays`
// function I wish I found a more elegant solution, not needing 3 variables for
// the indexes I decided to make all functions pure as I like it that way but I
// guess modifing the passed arguments would have been a nice solution to ease
